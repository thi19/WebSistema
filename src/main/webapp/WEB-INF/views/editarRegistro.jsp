...
<form ng-controller="editarRegistroController">
	...
	<input type="text" id="input-endereco" style="width:120px;" ng-model="endereco" ng-init="endereco='${usuarioModel.endereco}'"/>
 
	<br/><br/>
 
	<label for="input-numero">Numero:</label>
	<input type="password" id="input-numero" style="width:120px;" ng-model="numero" ng-init="numero='${usuarioModel.numero}'"/>
